...
<head>
        <meta charset="utf-8">
        <title>CRONOGRAMA DE MANTENIMIENTO DE BIOMEDICA</title>
...
<center>
                                ...
                                <br>
                                <br>
<center><font color="black" face="Arial black" size="7" >CRONOGRAMA DE MANTENIMIENTO DE BIOMEDICA</font></center>
                                <br>
                                <br>
<center><font color="red" face="Arial black" size="5" >Fechas para realizar mantenimiento a los aparatos medicos</font></center>
                                <br>
                                <br>
                <div class="row">
...
<font color="red" face="Arial black" size="7" >
...
<font color="blue" face="Arial black" size="7" >
                                        Calendario
</font>
                                    </button>
                                    </a>
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Revision</option>
                        <option value="event-success">Mantenimiento Preventivo</option>
                        <option value="event-important">Importantante</option>
                        <option value="event-warning">Urgente</option>
                        <option value="event-special">Reparacion</option>
                    </select>
                    ...
                    <label for="body">PROXIMO MANTENIMIENTO Y DIAGNOSTICO</label>
